...
<body>
    ...
    <script>
        ...
        function addQuestion() {
            ...
            if (questionCount > 1) {
                ...
                if (!previousQuestionIsFinal) {
                    document.querySelector(`input[name="questions[${previousQuestionId}][choices][${document.getElementById(`choicesContainer_${previousQuestionId}`).childElementCount}][next_question_id]"]`).value = questionCount; // Set next_question_id
                }
            }
        }
        ...
        function updateNextQuestionId(previousQuestionIndex, currentQuestionIndex) {
            ...
            if (!previousQuestionIsFinal) {
                document.querySelector(`input[name="questions[${previousQuestionIndex}][choices][${document.getElementById(`choicesContainer_${previousQuestionIndex}`).childElementCount}][next_question_id]"]`).value = currentQuestionIndex;
            }
        }
