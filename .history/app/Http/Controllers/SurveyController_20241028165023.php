    ...
    public function submitAnswers(Request $request)
    {
        ...
        try {
            $data = $request->validate([
                ...
                'answers.*.choice_id' => 'required|array', // Change to 'array' if multiple choices are allowed
                'answers.*.choice_id.*' => 'integer|exists:choices,id' // Ensure each choice_id in array is valid
            ]);


            // If validation passes, create answers
            foreach ($data['answers'] as $questionId => $choiceIds) {
