...
class SurveyController extends Controller
{
    ...
    {
        // Output all incoming request data for debugging
        dd($request->all());
        ...
        $data = $request->validate([
            ...
            'answers.*.choice_id.required' => 'Choice ID is required.',
            'answers.*.question_id.exists' => 'The selected question does not exist.',
            'answers.*.choice_id.exists' => 'The selected choice does not exist.',
        ]);

        // Loop through the answers and create records
